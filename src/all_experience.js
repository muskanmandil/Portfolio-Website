...
const all_experience = [{
    ...
    summary: [
        "Designed user-centric database chat interface software prioritizing intuitive interaction.",
    ...
    summary: [
        "Ranked among the Top 5 teams nationwide in Smart India Hackathon 2023.",
